    ...
    <div className="w-full max-w-max flex flex-col gap-4">
      ...
      <div className="w-[95%] border-slate-300 border-[1px] self-center rounded-md p-4">
        ...
        <input
          ...
          className=" placeholder:text-[14px] border-[1px] border-black px-1 w-[120px] h-[20px] self-center mb-2"
        />
        <textarea
          name="textarea"
          id="textarea"
          placeholder="Your comment..."
          className=" placeholder:text-[14px] pt-4 pr-14 border-[1px] border-black placeholder:justify-center mb-1"
        ></textarea>
