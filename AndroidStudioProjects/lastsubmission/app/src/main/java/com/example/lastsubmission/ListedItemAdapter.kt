...
import com.example.lastsubmission.R
import com.example.lastsubmission.food

class ListHeroAdapter(private val listFood: ArrayList<food>) : RecyclerView.Adapter<ListHeroAdapter.ListViewHolder>() {
